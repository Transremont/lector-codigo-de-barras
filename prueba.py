...
#Descripcion 
    ...
    texto_sele.pack()
#Boton 1
    registrar=tkinter.Button(ven_inicial, text="Registrar activos")
    registrar.place(x=80, y=100)
#Boton 2
    Consulta=tkinter.Button(ven_inicial, text="Consultar activos")
...
#Seccion de arriba y descripcion de que hacer para que funcione el programa
        btn_ven1= tkinter.Button(ventana1, text="Ventana 1", command=inicial1())
